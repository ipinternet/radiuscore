...
class Container_2c1e2e62e8 extends _PHPStan_7891782a6\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_2c1e2e62e8 $container)
			{
	...
	public function createServiceContainer(): Container_2c1e2e62e8
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'APP_KEY' => 'base64:BNary9D+nYyjOfIIzHiINzxhkQ/1aeqMQSFhgstyW18=',
				'APP_LOCALE' => 'en',
