...
class Container_3b3f12401b extends _PHPStan_7891782a6\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_3b3f12401b $container)
			{
	...
	public function createServiceContainer(): Container_3b3f12401b
	{
		return $this;
	}
